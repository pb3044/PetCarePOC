        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    PreferredServiceTypes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PreferredProviderAttributes = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenseInfo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BackgroundCheckVerified = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    BankingInfo = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalInformation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    FeedingInstructions = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExerciseNeeds = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BehavioralNotes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    VeterinarianPhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AvailabilitySchedules_ServiceProviders_ProviderId",
            ...
            migrationBuilder.CreateTable(
                name: "PetOwnerServiceProvider",
                columns: table => new
                {
                    FavoriteProvidersId = table.Column<int>(type: "int", nullable: false),
                    FavoritedByOwnersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetOwnerServiceProvider", x => new { x.FavoriteProvidersId, x.FavoritedByOwnersId });
                    table.ForeignKey(
                        name: "FK_PetOwnerServiceProvider_PetOwners_FavoritedByOwnersId",
                        column: x => x.FavoritedByOwnersId,
                        principalTable: "PetOwners",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PetOwnerServiceProvider_ServiceProviders_FavoriteProvidersId",
                        column: x => x.FavoriteProvidersId,
                        principalTable: "ServiceProviders",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitude = table.Column<double>(type: "float", nullable: true),
                    Longitude = table.Column<double>(type: "float", nullable: true),
                    AcceptedPetTypes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AcceptedPetSizes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MaxPetsPerBooking = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_PetOwners_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "PetOwners",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderPayout = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetOwnerServiceProvider_FavoritedByOwnersId",
                table: "PetOwnerServiceProvider",
                column: "FavoritedByOwnersId");
